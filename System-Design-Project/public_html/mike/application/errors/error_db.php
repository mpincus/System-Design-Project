...
<div class="wrapper">
    ...
    <div class="width-limiter">
        <div id="logo">
            <a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>"><img
                    src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/img/logo.jpg" alt="Community Auth"/></a>
        </div>
...
<div class="footer">
    <p>Copyright (c) 2011 - <?php echo date('Y'); ?> &bull; Robert B. Gottier &bull; <a
            href="http://brianswebdesign.com">Brian's Web Design - Temecula, CA</a></p>
</div>
</body>
</html><?php
