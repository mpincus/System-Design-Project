...
?>
    ...
    <h1>Screenshots</h1>
    <p>
        Since there is no demo to allow you to check out what you see when logged in to Community Auth, some screenshots
        have been provided below. Community Auth has a user recovery process, as well as a registration process. No
        screenshots have been provided for those processes.
    </p>
