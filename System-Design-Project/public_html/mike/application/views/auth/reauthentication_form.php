...
echo form_open('', array('class' => 'std-form', 'style' => 'margin-top:20px;')); ?>
    ...
    <div class="form-column-left">
        <div class="form-row">
            ...
            <input type="text" name="login_string" id="login_string" class="form_input" autocomplete="off"
                   maxlength="255" value="<?php echo set_value('login_string'); ?>"/>
        </div>
        <div class="form-row">
            ...
            <input type="password" name="login_pass" id="login_pass" class="form_input password" autocomplete="off"
                   maxlength="<?php echo MAX_CHARS_4_PASSWORD; ?>" value="<?php echo set_value('login_pass'); ?>"/>
        </div>
        <div class="form-row">
