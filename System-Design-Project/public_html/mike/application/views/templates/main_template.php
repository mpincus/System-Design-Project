...
<body id="<?php echo $this->router->fetch_class() . '-' . $this->router->fetch_method(); ?>"
      class="<?php echo $this->router->fetch_class(); ?>-controller <?php echo $this->router->fetch_method(); ?>-method">
        ...
        <div id="two-right">
            ...
            if (!$this->uri->segment(1)) {
                ...
                <div id="downloads">
                    <h3>Downloads</h3>
                    <ul>
                        <li><a href="https://bitbucket.org/skunkbad/community-auth/get/tip.zip">Tip <span>(Installed in CodeIgniter)</span></a>
                        </li>
                        <li>
                            <a href="https://bitbucket.org/skunkbad/community-auth/get/<?php echo TAG; ?>.zip"><?php echo TAG; ?>
                                <span>(Installed in CodeIgniter)</span></a></li>
                        <li>
                            <a href="https://bitbucket.org/skunkbad/community-auth/downloads/community-auth-<?php echo TAG; ?>-isolated.zip"><?php echo TAG; ?>
                                Files Only <span>(Without CodeIgniter)</span></a></li>
                    </ul>
                </div>
            <?php
            }
...
<div class="footer">
    <p>Copyright (c) 2011
        - <?php echo date('Y') . ' &bull; Robert B. Gottier &bull; ' . anchor('http://brianswebdesign.com', 'Brian\'s Web Design - Temecula, CA') . ' &bull; ' . anchor('privacy', 'Privacy Policy'); ?></p>
</div>
<?php
