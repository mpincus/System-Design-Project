...
<div class="wrapper">
    <div id="indicator">
        <div>
            <?php
            echo (isset($auth_user_name)) ? 'Welcome, ' . $auth_user_name . ' &bull; ' . secure_anchor('user', 'User Index') . ' &bull; ' . secure_anchor('user/logout', 'Logout') : secure_anchor('register', 'Register') . ' &bull; ' . secure_anchor('user', 'Login');
            ?>
        </div>
    </div>
        ...
        <div id="two-right">
            <div id="menu">
                ...
                <p style="padding-bottom:5px;">
                    Test users should be created before any other users because their user IDs are not checked for
                    duplicates.
                </p>
            </div>
        </div>
...
<div class="footer">
    <p>Copyright (c) 2011 - <?php echo date('Y'); ?> &bull; Robert B.
        Gottier &bull; <?php echo anchor('http://brianswebdesign.com', 'Brian\'s Web Design - Temecula, CA'); ?></p>
</div>
</body>
</html>
<?php
