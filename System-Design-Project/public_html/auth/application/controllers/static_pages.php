...
//----------------------------------------------------------------------------------------
	...
	public function cost()
	{
		$data = array(
			...
			'description' => 'Not sure Community Auth is right for you? See soof the areas in Community Auth that require login.',
			'content' => $this->load->view( 'static_pages/cost', '', TRUE )
		);
    ...
    {
        $data = array(
            'title' => WEBSITE_NAME . ' - financial aid',
            'description' => 'Not sure Community Auth is right for you? See soof the areas in Community Auth that require login.',
            'content' => $this->load->view( 'static_pages/financial', '', TRUE )
        );
    ...
    {
        $data = array(
            'title' => WEBSITE_NAME . ' - student life',
            'description' => 'Not sure Community Auth is right for you? See soof the areas in Community Auth that require login.',
            'content' => $this->load->view( 'static_pages/studentlife', '', TRUE )
        );
    ...
    public function academics()
    {
        $data = array(
            'title' => WEBSITE_NAME . ' - student life',
            'description' => 'Not sure Community Auth is right for you? See soof the areas in Community Auth that require login.',
            'content' => $this->load->view( 'static_pages/academics', '', TRUE )
        );
    ...
    {
        $data = array(
            'title' => WEBSITE_NAME . ' - apply',
            'description' => 'Not sure Community Auth is right for you? See soof the areas in Community Auth that require login.',
            'content' => $this->load->view( 'static_pages/apply', '', TRUE )
        );
    ...
    {
        $data = array(
            'title' => WEBSITE_NAME . ' transfer',
            'description' => 'Not sure Community Auth is right for you? See soof the areas in Community Auth that require login.',
            'content' => $this->load->view( 'static_pages/transfer', '', TRUE )
        );
    ...
    {
        $data = array(
            'title' => WEBSITE_NAME . ' eop',
            'description' => 'Not sure Community Auth is right for you? See soof the areas in Community Auth that require login.',
            'content' => $this->load->view( 'static_pages/eop', '', TRUE )
        );
    ...
    {
        $data = array(
            'title' => WEBSITE_NAME . ' international',
            'description' => 'Not sure Community Auth is right for you? See soof the areas in Community Auth that require login.',
            'content' => $this->load->view( 'static_pages/international', '', TRUE )
        );
    ...
    {
        $data = array(
            'title' => WEBSITE_NAME . ' graduate',
            'description' => 'Not sure Community Auth is right for you? See soof the areas in Community Auth that require login.',
            'content' => $this->load->view( 'static_pages/graduate', '', TRUE )
        );
    ...
    {
        $data = array(
            'title' => WEBSITE_NAME . ' nondegree',
            'description' => 'Not sure Community Auth is right for you? See soof the areas in Community Auth that require login.',
            'content' => $this->load->view( 'static_pages/nondegree', '', TRUE )
        );
